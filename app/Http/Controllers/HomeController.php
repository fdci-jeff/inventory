...
class HomeController extends Controller
{
    ...
    public function salesChartData() {
        ...
        $sales = Sale::selectRaw("DATE_FORMAT(date,'%d-%m-%y') as date,  SUM(total_amount) AS count")
    ...
    public function purchasesChartData() {
        ...
        $purchases = Purchase::selectRaw("DATE_FORMAT(date,'%d-%m-%y') as date,  SUM(total_amount) AS count")
            ->where('status', 'Completed')
            ->where('date', '>=', $date_range)
            ->groupBy(DB::raw("DATE_FORMAT(date,'%d-%m-%y')"))
            ->orderBy('date')
    ...
    public function paymentChart() {
        ...
        $sale_payments = SalePayment::where('date', '>=', $date_range)
            ->selectRaw("DATE_FORMAT(date, '%m-%Y') as month,  SUM(amount) as amount")
